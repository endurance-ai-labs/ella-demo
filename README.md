# Remi — A.I. Voice Agent (marketing demo)

A single-page marketing demo for **Remi**, the A.I. voice agent that remembers every
...
console.html   # product console dashboard ("This week with Remi")
console.css    # console design tokens (blue/slate SaaS palette)
```

## Surfaces
- **Landing** (`index.html`) — long-scroll marketing page positioning Remi as an
...
- **Console** (`console.html`) — the product dashboard a customer logs into,
  recreated from the `Remi Console` design handoff in the blue/slate SaaS palette
  ...
  "Recent conversations" memory feed, and an "Ask Remi" popover. All sample data.
...
---
© 2026 Remi · An Endurance Labs product
